        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    {answer !== null && (
                        <div className="mb-3 py-3 rounded text-white bg-emerald-600 text-xl">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg relative">
                        {availableCredits !== null &&
                            feature.required_credits > availableCredits && (
                                <div className="absolute left-0 right-0 bottom-0 z-20 flex flex-col items-center justify-center bg-white/70 gap-3">
                                    <svg
                                    ...
                                    <div className="p-8 text-gray-600 border-b pb-4 ">
                                        <p>{feature.description}</p>
                                        <div className="text-sm italic text-center">
                                            Requires {feature.required_credits}{" "}
                                            credits
                                        </div>
                                    </div>
                                </div>
